define({ "api": [
  ...
  },
  {
    ...
    "title": "belongVip",
    "name": "belongVip",
    "description": "<p>判断是不是属于某个企业的vip</p>",
    "group": "企业",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "cmd",
            "description": "<p>getOpenIdByCode</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "typeID",
            "description": "<p>页面类目，1.一级商家  2.二级商家 3.员工名片 4.产品详情 暂定这几个页面</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>头像图片的文件id(如果为为空或者和原来一样，则代表没有修改过)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
